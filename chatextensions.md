...
[Edit](https://vscode.dev/github/microsoft/vscode-docs/blob/main/api/extension-guides/chat.md "Edit this document in vscode.dev")
...
## [Extending GitHub Copilot via GitHub Apps](\#extending-github-copilot-via-github-apps)
...
## [Parts of the chat user experience](\#parts-of-the-chat-user-experience)
...
![Chat concepts explanation](/assets/api/extension-guides/chat/chat.png)
...
8. Suggested [follow-up questions](#register-follow-up-requests) provided by the chat participant
9. Chat input field with the placeholder text provided by the chat participant's `description` property

## [Develop a chat extension](\#develop-a-chat-extension)
...
![Diagram showing how extension can contribute to chat](/assets/api/extension-guides/chat/diagram.png)

### [Register the chat extension](\#register-the-chat-extension)
...
### [Implement a request handler](\#implement-a-request-handler)
...
2. Determine the intent of the user's request
3. Perform logic to answer the user's question
...
![Response from the cat extension that includes code, markdown and a button](/assets/api/extension-guides/chat/stream.png)
...
![List of commands in chat for @workspace](/assets/api/extension-guides/chat/commands.png)
...
### [Register follow-up requests](\#register-followup-requests)
...
### [Implement participant detection](\#implement-participant-detection)
...
## [Naming restrictions and conventions](\#naming-restrictions-and-conventions)

### [Chat participant naming conventions](\#chat-participant-naming-conventions)
...
### [Slash command naming conventions](\#slash-command-naming-conventions)
...
- [![RSS](/assets/community/sidebar/rss.svg)Subscribe](/feed.xml)
- [![Stackoverflow](/assets/community/sidebar/stackoverflow.svg)Ask questions](https://stackoverflow.com/questions/tagged/vscode)
- [![Twitter](/assets/community/sidebar/twitter.svg)Follow @code](https://go.microsoft.com/fwlink/?LinkID=533687)
- [![GitHub](/assets/community/sidebar/github.svg)Request features](https://go.microsoft.com/fwlink/?LinkID=533482)
- [![Issues](/assets/community/sidebar/issue.svg)Report issues](https://www.github.com/Microsoft/vscode/issues)
- [![YouTube](/assets/community/sidebar/youtube.svg)Watch videos](https://www.youtube.com/channel/UCs5Y5_7XK8HLDX0SLNwkd3w)